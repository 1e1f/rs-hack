...
mod tests {
    use super::*;
    use crate::arch::ticket::ItemType;
    ...
    fn flags_stacked_handoff_over_threshold() {
        ...
        let board = TicketBoard { tickets: vec![t.clone()], kg_board: kg::board::Board::default() };
    ...
    fn flags_parent_active_with_terminal_children() {
        ...
        let board = TicketBoard { tickets: vec![parent.clone(), child], kg_board: kg::board::Board::default() };
