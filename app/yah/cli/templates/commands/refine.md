...
Create `.yah/arch/authored/{topic}.md` with the full plan. Keep the prose — it's context future agents need.
...
RELAY=$(yah board open \
  ...
  --see .yah/arch/authored/processblock_unification.md)
echo "$RELAY"   # e.g. R012
```
...
```
Created:
  .yah/arch/authored/cv_port_bridge.md — full plan
