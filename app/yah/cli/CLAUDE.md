...
The `yah` binary: source-embedded tickets (hack-board), AST refactoring, MCP server. Workspace-wide rules live in the root [CLAUDE.md](../../../CLAUDE.md); this file is the **hack-board SDLC**, which applies whenever you work with `@yah:` annotations or the kanban UI.
