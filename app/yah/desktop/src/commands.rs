...
//!
//! The param/return types come straight from `rpc` — they're
...
/// — both paths flow through `kg::prompt::render`.
///
...
#[tauri::command]
pub async fn rig_detach(state: tauri::State<'_, AppState>, rig_id: RigId) -> Result<bool, String> {
