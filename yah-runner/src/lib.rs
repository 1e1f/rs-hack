//! @arch:layer(kg_store)
//! @arch:role(bridge)
//! @arch:see(architecture/yah-runner.md)
...
//! (`architecture/yah-agent-runtime.md`'s "Composable runtime matrix"):
...
//! ## Contract
//!
//! Both runners consume a fully-assembled [`yah_kg::prelude::Prelude`] and
//! emit the same [`yah_kg::agent::AgentEvent`] stream. That keeps the
...
pub use yah_kg::agent::{AgentEvent, Message, Role, SessionId};
pub use yah_kg::prelude::Prelude;
