...
/// Result of [`crate::rpc::method::FILE_READ`]. `content` is decoded
...
/// Result of [`crate::rpc::method::FILE_WRITE`]. `mtime_ms` is the
...
/// Result of either [`crate::rpc::method::FILE_WATCH`] or
/// [`crate::rpc::method::DIR_WATCH`]. The handle id is per-rig-process
...
/// gathers everything pure [`crate::prelude::assemble`] needs — board,
...
pub struct AssemblePreludeParams {
    ...
    /// Forwarded to [`crate::prelude::PreludeOptions::max_tokens`]. Daemon
    /// applies the `PreludeOptions` default when omitted.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub max_tokens: Option<u32>,
    /// Forwarded to [`crate::prelude::PreludeOptions::kg_node_limit`].
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub kg_node_limit: Option<u32>,
    /// Forwarded to [`crate::prelude::PreludeOptions::arch_inline_max_bytes`].
    #[serde(default, skip_serializing_if = "Option::is_none")]
