...
mod tests {
    ...
    fn known_ticket() -> WorkItemAnno {
        ...
        a.see_also
            .push("architecture/yah-agent-runtime.md".into());
        a
    }
...
## Arch doc: architecture/yah-agent-runtime.md

_Reference: `architecture/yah-agent-runtime.md` (not pre-loaded)._
