...
pub struct WorkItemAnnoWire {
    ...
    /// forward compat (see [`kg::agent_policy::SCHEMA_VERSION`]).
...
impl AnnotationIndexSnapshotWire {
    pub fn pack(
        s: kg_anno::AnnotationIndexSnapshot,
        ix: &mut StringInterner,
        nx: &mut NodeIdInterner,
    ) -> Self {
        Self {
    ...
    pub fn unpack(
        ...
        r: &StringResolver<'_>,
        nr: &NodeIdResolver<'_>,
    ) -> kg_anno::AnnotationIndexSnapshot {
        kg_anno::AnnotationIndexSnapshot {
            entries: self
                .entries
                .into_iter()
...
mod tests {
    ...
    fn fingerprints_round_trip_through_postcard() {
        ...
        let snap = KgSnapshot {
            ...
            annotations: kg_anno::AnnotationIndexSnapshot { entries: vec![] },
        };
