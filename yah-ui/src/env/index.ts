 ...
 *  `has(provider)` for UI gating. See architecture/settings-api-keys.md. */
...
export interface Rpc {
   ...
   *  lazy-expand under the Files tab. Mirrors `yah_kg::rpc::DirListParams`. */
   ...
   *  after a daemon restart. Mirrors `yah_kg::rpc::DirWatchParams`. */
   ...
   *  [`IdentityRpc`] and architecture/yah-identities.md. */
