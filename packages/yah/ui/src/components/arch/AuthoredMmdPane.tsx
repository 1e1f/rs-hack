...
//! @yah:handoff("Three-axis relay: (1) extend .yah/arch/authored/ to accept .md (today only .mmd is rendered); (2) surface @arch:see(...) on ticket cards as clickable yah:// links to the arch tab; (3) migrate architecture/*.md into .yah/arch/authored/ and retire the architecture/ root. Reusable Markdown component already lives at packages/yah/ui/src/components/agent/messages/Markdown.tsx (R028-F4 — handles fenced code, headings, lists, tables, yah:// link routing, copy-as-source). Ticket scanner already captures @arch:see lines on the work-item via see_also (crates/yah/kg-anno/src/parser.rs:130-141) — purely a renderer/UI lift, no scanner changes.")
