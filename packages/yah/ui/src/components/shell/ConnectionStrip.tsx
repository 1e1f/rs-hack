...
//! @yah:next("Consider piping a manual reindex retry button into the offline state — design doc shows '[retry]' affordance at .yah/arch/authored/yah-ui-implementation-guide.md:377.")
