...
interface BoardProps {
  ...
  /* yah:// router — threaded into TicketCard so the expanded card's
     References chips (`@arch:see` entries) route through App. Optional
     so this component still works in test/storybook contexts. */
